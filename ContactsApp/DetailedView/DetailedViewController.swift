...
class DetailedViewController: UIViewController {
    ...
    private lazy var phoneIcon = RoundIcon(name: "PhoneIcon", color: UIColor(named: "CallColor") ?? .systemGreen)
    private lazy var smsIcon = RoundIcon(name: "SmsIcon", color: UIColor(named: "SmsColor") ?? .systemOrange)
