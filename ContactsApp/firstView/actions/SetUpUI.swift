...
extension ViewController {
    func setUpButtonsTargets() {
        ...
        headerView.moreOptions.addTarget(self, action: #selector(moreOptionTap), for: .touchUpInside)
        
        dropDownMenu.sortOptions.addTarget(self, action: #selector(sortByTap), for: .touchUpInside)
    ...
    func setUpDropDown() {
        ...
        NSLayoutConstraint.activate([
            dropDownMenu.topAnchor.constraint(equalTo: headerView.moreOptions.topAnchor),
            dropDownMenu.rightAnchor.constraint(equalTo: headerView.moreOptions.rightAnchor),
    ...
    func setUpSortDropDown() {
        ...
        NSLayoutConstraint.activate([
            sortDropDown.topAnchor.constraint(equalTo: headerView.moreOptions.topAnchor),
            sortDropDown.rightAnchor.constraint(equalTo: headerView.moreOptions.rightAnchor),
    ...
    func setUpSearch() {
        ...
        NSLayoutConstraint.activate([
            ...
            searchHeader.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 70),
